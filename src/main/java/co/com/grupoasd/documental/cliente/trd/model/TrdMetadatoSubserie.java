/*
* Archivo: TrdMetadatoSubserie.java
...
public class TrdMetadatoSubserie implements Serializable{
    ...
    private int subserieId;
    private int tipoDatoId;
    private String nombreTipoDato;
    
    public TrdMetadatoSubserie() {
    
    }
    
    public TrdMetadatoSubserie(int metadatoId, int subserieId) {
     ...
     */
    public int getSubserieId() {
        return subserieId;
    }
    /**
     * @param subserieId the subserieId to set
     */
    public void setSubserieId(int subserieId) {
        this.subserieId = subserieId;
    }
    /**
    ...
    public int hashCode() {
        ...
        result = prime * result + subserieId;
        return result;
    }
    /* (non-Javadoc)
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TrdMetadatoSubserie other = (TrdMetadatoSubserie) obj;
        if (metadatoId != other.metadatoId)
            return false;
        if (subserieId != other.subserieId)
            return false;
        return true;
    }
    /* (non-Javadoc)
    ...
    public String toString() {
        return "TrdMetadatoSubserie [orden=" + orden + ", obligatorio=" + obligatorio + ", inactivo=" + inactivo + ", "
                ...
                + (nombreMetadato != null ? "nombreMetadato=" + nombreMetadato + ", " : "") + "subserieId=" + subserieId
                + "]";
    }
