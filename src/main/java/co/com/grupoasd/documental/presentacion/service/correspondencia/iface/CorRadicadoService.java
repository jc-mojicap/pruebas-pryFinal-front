 ...
 *
 */
public interface CorRadicadoService {
     ...
     * 
     * @param token
     *            Token con identificacion del usuario.
     * @param corRadicado
     *            Objeto CorRadicado.
    ...
    /**
     * Busca un radicado por empresa y código de radicado.
     * 
     * @param empresaId
     ...
     * @return Objeto corRadicado
     */
    CorRadicado obtenerPorId(Long id);
     ...
     * @return Objeto CorRadicado
     */
    CorRadicado anularRadicado(Token token, CorRadicado corRadicado);
     ...
     * @return Objeto CorRadicado
     */
    CorRadicado asignarResponsables(Token token, CorRadicado corRadicado);

    /**
     * Actualiza un CorRadicado.
     * @param token Token de autenticación.
     * @param radicado CorRadicado a actualizar.
     * @return radicado actualizado.
     */
    public CorRadicado actualizarRadicado(Token token, CorRadicado radicado);
}
