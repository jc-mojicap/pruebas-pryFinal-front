/*
 * Archivo: EstadoRadicadoServiceImpl.java
 ...
 *
 */
public class CorRadicadoServiceImpl implements CorRadicadoService {
    ...
    @Override
    public List<CorRadicado> listarRadicadosComunicacionPorFiltros(CorRadicado filtros) {
        return CorRadicadoProxyService.listar(filtros);
    }


    @Override
    public CorRadicado crear(Token token, CorRadicado corRadicado) {
        return CorRadicadoProxyService.crear(token, corRadicado);
    }


    @Override
    public CorRadicado buscarPorEmpresaYRadicado(Integer empresaId, String radicado) {
        return CorRadicadoProxyService.buscarPorRadicadoYEmpresa(empresaId, radicado);
    }
	...
	@Override
	public CorRadicado obtenerPorId(Long id) {
		return CorRadicadoProxyService.obtenerPorId(id);
	}

	@Override
	public CorRadicado actualizarRadicado(Token token, CorRadicado corRadicado) {
		return CorRadicadoProxyService.actualizarRadicado(token, corRadicado);
	}

	@Override
	public CorRadicado anularRadicado(Token token, CorRadicado corRadicado) {
		return CorRadicadoProxyService.anularRadicado(token, corRadicado);
	}

	@Override
	public CorRadicado asignarResponsables(Token token, CorRadicado corRadicado) {
		return CorRadicadoProxyService.asignarResponsables(token, corRadicado);
	}
}
